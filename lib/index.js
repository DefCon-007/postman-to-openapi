...
function postmanToOpenApi (collectionData, {
  ...
  if (replaceVars) {
    _postmanJson = JSON.parse(replacePostmanVariables(collectionData, additionalVars))
  } else {
    _postmanJson = Object.getPrototypeOf(collectionData) === Object.prototype ? collectionData : JSON.parse(collectionData)
  }
